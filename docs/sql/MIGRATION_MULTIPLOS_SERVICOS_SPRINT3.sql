-- ============================================================================
-- MIGRATION: Sprint 3 - Suporte a Múltiplos Serviços por Agendamento
-- Objetivo: Permitir que um agendamento tenha múltiplos procedimentos
-- Data: 2026-06-16
-- ============================================================================

-- 1. Criar tabela de junção para atendimento_procedimentos
...
-- 2. Criar função para calcular totais do agendamento baseado em seus procedimentos
...
-- 3. Criar trigger para sincronizar totais
...
for each row
execute function atualizar_totais_atendimento();

-- 4. View para facilitar consultas com procedimentos expandidos
...
comment on table atendimento_procedimentos is 'Tabela de junção: um atendimento pode ter múltiplos procedimentos (Sprint 3)';
comment on column atendimento_procedimentos.valor_indicado is 'Valor sugerido pelo sistema (preço tabela do procedimento)';
comment on column atendimento_procedimentos.valor_cobrado is 'Valor real cobrado (pode diferir da tabela)';
comment on column atendimento_procedimentos.sequencia is 'Ordem de execução dos procedimentos';

-- 6. Backup: Popular atendimento_procedimentos com dados existentes (se houver)
...
select
  ...
  a.procedimento_id,
  a.comprimento,
  0, -- valor_indicado será calculado pelo frontend
  a.valor_cobrado,
  a.valor_pago,
  1
from atendimentos a
