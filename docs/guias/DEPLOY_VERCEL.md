...
1. Acesse: https://supabase.com/dashboard/project/SEU_PROJETO_SUPABASE_REF/auth/url-configuration
...
- **Supabase Dashboard:** https://supabase.com/dashboard/project/SEU_PROJETO_SUPABASE_REF
