...
create table procedimentos (
  ...
  ativo                    boolean not null default true,
  -- NOVAS COLUNAS V6: PRODUTO APLICADO
  preco_frasco             numeric(10,2) default 0,
  aplicacoes_por_frasco    integer default 1,
  unidade_medida           text default 'aplicação',
...
-- ────────── NOVO V6: TRIGGER PARA PRODUTO_APLICADO ──────────
