...
supabase link --project-ref SEU_PROJETO_SUPABASE_REF
...
1. Acesse: https://supabase.com/dashboard/project/SEU_PROJETO_SUPABASE_REF/functions
...
curl -X POST \
  https://SEU_PROJETO_SUPABASE_REF.supabase.co/functions/v1/criar-admin \
