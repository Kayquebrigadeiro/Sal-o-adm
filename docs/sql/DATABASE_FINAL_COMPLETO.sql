...
-- ════════════════════════════════════════════════════════════════════════════
-- NOVA TABELA: Logins Gerados (para Vendedor/Admin)
-- ════════════════════════════════════════════════════════════════════════════
...
-- ✓ Tabela logins_gerados para ratrear proprietárias criadas
...
-- 6. Crie sua conta de VENDEDOR manualmente no Auth
-- 7. Insira o perfil em perfis_acesso
-- 8. Pronto! Sistema completo
-- ════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
